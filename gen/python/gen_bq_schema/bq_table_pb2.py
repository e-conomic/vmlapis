...
bigquery_opts = _descriptor.FieldDescriptor(
  ...
  serialized_options=None, json_name='bigqueryOpts', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key)
...
_BIGQUERYMESSAGEOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='useJsonNames', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
