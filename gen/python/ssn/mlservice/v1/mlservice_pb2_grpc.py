...
class MlServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetPrediction = channel.unary_unary(
        ...
        request_serializer=ssn_dot_mlservice_dot_v1_dot_mlservice__pb2.MlRequest.SerializeToString,
        response_deserializer=ssn_dot_mlservice_dot_v1_dot_mlservice__pb2.MlResponse.FromString,
        )
...
def add_MlServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetPrediction': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=ssn_dot_mlservice_dot_v1_dot_mlservice__pb2.MlRequest.FromString,
          response_serializer=ssn_dot_mlservice_dot_v1_dot_mlservice__pb2.MlResponse.SerializeToString,
      ),
  }
