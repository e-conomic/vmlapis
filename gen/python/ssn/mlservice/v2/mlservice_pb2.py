...
_FEATUREGENREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='ssn.mlservice.v2.FeatureGenRequest.id', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='truth_labels', full_name='ssn.mlservice.v2.FeatureGenRequest.truth_labels', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='text_annotation', full_name='ssn.mlservice.v2.FeatureGenRequest.text_annotation', index=2,
