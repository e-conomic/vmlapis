...
_RASTERIZEPDFREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='dpi', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
...
RasterizePdfRequest = _reflection.GeneratedProtocolMessageType('RasterizePdfRequest', (_message.Message,), {
...
RasterizePdfResponse = _reflection.GeneratedProtocolMessageType('RasterizePdfResponse', (_message.Message,), {
