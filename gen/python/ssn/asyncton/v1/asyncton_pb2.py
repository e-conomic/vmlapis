...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'Z?github.com/e-conomic/vmlapis/gen/go/ssn/asyncton/v1;transaction\222A8\022\017\n\tAsync API2\002v1*\001\0022\020application/json:\020application/json'
  ...
  _TRANSACTIONSERVICE.methods_by_name['GetTransactionResults']._serialized_options = b'\202\323\344\223\002;\022\035/v1/transactions/{id}/resultsZ\032\022\030/v1/transactions/results'
  _TRANSACTIONSERVICE.methods_by_name['GetTransactionStatus']._options = None
  _TRANSACTIONSERVICE.methods_by_name['GetTransactionStatus']._serialized_options = b'\202\323\344\223\0029\022\034/v1/transactions/{id}/statusZ\031\022\027/v1/transactions/status'
  _TRANSACTIONSERVICE.methods_by_name['DeleteTransaction']._options = None
  _TRANSACTIONSERVICE.methods_by_name['DeleteTransaction']._serialized_options = b'\202\323\344\223\002+*\025/v1/transactions/{id}Z\022*\020/v1/transactions'
