...
class MetricsRequest(_message.Message):
    __slots__ = ["start_time", "end_time", "fields", "tags", "country_codes"]
    ...
    def __init__(self, start_time: _Optional[int] = ..., end_time: _Optional[int] = ..., fields: _Optional[_Iterable[str]] = ..., tags: _Optional[_Iterable[str]] = ..., country_codes: _Optional[_Iterable[str]] = ...) -> None: ...
