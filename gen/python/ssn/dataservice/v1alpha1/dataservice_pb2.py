...
_DOCUMENT.fields_by_name['prediction_values'].message_type = _TRUEVALUES
...
_PREPAREFEEDBACKREQUEST.fields_by_name['predictions'].message_type = _TRUEVALUES
