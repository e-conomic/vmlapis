...
class GetTextAnnotationResponse(_message.Message):
    __slots__ = ["text_annotation", "image", "last_image", "language_code"]
    ...
    language_code: str
    def __init__(self, text_annotation: _Optional[_Union[_text_annotation_pb2.TextAnnotation, _Mapping]] = ..., image: _Optional[_Union[_wrappers_pb2.BytesValue, _Mapping]] = ..., last_image: _Optional[_Union[_wrappers_pb2.BytesValue, _Mapping]] = ..., language_code: _Optional[str] = ...) -> None: ...
