...
_CANDIDATE.fields_by_name['bounding_box'].message_type = ssn_dot_types_dot_geometry__pb2._BOUNDINGPOLY
...
Confidence = _reflection.GeneratedProtocolMessageType('Confidence', (_message.Message,), dict(
  ...
  __module__ = 'ssn.types.candidate_pb2'
