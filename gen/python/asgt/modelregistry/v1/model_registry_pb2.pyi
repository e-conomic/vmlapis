...
class RegisterModelRequest(_message.Message):
    __slots__ = ["dataset", "revision", "model_version", "metrics", "target_metrics", "input_type", "train_statistics", "dataset_statistics", "target_to_confidence_thresholds", "metric_version", "tail_target_to_confidence_thresholds"]
    ...
    class TailTargetToConfidenceThresholdsEntry(_message.Message):
        __slots__ = ["key", "value"]
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: str
    ...
    TAIL_TARGET_TO_CONFIDENCE_THRESHOLDS_FIELD_NUMBER: _ClassVar[int]
    ...
    metric_version: str
    tail_target_to_confidence_thresholds: _containers.MessageMap[str, _model_pb2.ConfidenceThresholds]
