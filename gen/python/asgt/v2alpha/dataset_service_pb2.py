...
_CREATEDATASETREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\372B*\222\001\'\"%r#(\200\0022\036^[A-Za-z0-9.][A-Za-z0-9_.>-]*$\372B\005\222\001\002\030\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='target_value', full_name='asgt.v2alpha.CreateDatasetRequest.target_value', index=2,
...
_CREATEDATASETREQUEST.fields_by_name['target_value'].message_type = asgt_dot_type_dot_target__value__pb2._TARGETVALUE
