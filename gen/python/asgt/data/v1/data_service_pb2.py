...
_CREATEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='target_value', full_name='asgt.dataservice.v1.CreateRequest.target_value', index=6,
...
_CREATEREQUEST.fields_by_name['target_value'].message_type = asgt_dot_type_dot_target__value__pb2._TARGETVALUE
