...
_CREATEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=_b('\372B\027r\025(\200\0022\020^[0-9A-Za-z_-]+$'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\372B2r0R\017scanned-invoiceR\027electronic-invoice-lineR\004bank'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_CREATEREQUEST.fields_by_name['type']._options = None
_CREATEREQUEST.fields_by_name['targets']._options = None
_APPENDDATAREQUEST.fields_by_name['name']._options = None
_APPENDDATAREQUEST.fields_by_name['type']._options = None
_DELETEREQUEST.fields_by_name['type']._options = None
_GETINFOREQUEST.fields_by_name['name']._options = None
_GETINFOREQUEST.fields_by_name['type']._options = None
_UPDATEDATASETREQUEST.fields_by_name['name']._options = None
_UPDATEDATASETREQUEST.fields_by_name['type']._options = None
