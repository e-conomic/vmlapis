...
class DataServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.AppendData = channel.unary_unary(
        ...
        request_serializer=asgt_dot_data_dot_v1alpha1_dot_append__pb2.AppendDataRequest.SerializeToString,
        response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
        )
...
def add_DataServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'CreateDataset': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=asgt_dot_data_dot_v1alpha1_dot_create__pb2.CreateRequest.FromString,
          response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
      ),
      'AppendData': grpc.unary_unary_rpc_method_handler(
          servicer.AppendData,
          request_deserializer=asgt_dot_data_dot_v1alpha1_dot_append__pb2.AppendDataRequest.FromString,
          response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
      ),
      'DeleteData': grpc.unary_unary_rpc_method_handler(
          servicer.DeleteData,
          request_deserializer=asgt_dot_data_dot_v1alpha1_dot_delete__pb2.DeleteRequest.FromString,
          response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
      ),
      'GetInfo': grpc.unary_unary_rpc_method_handler(
          servicer.GetInfo,
          request_deserializer=asgt_dot_data_dot_v1alpha1_dot_info__pb2.GetInfoRequest.FromString,
          response_serializer=asgt_dot_data_dot_v1alpha1_dot_info__pb2.GetInfoResponse.SerializeToString,
      ),
  }
