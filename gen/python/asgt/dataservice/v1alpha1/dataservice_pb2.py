...
_ENTRY_PREDICTIONVALUESENTRY.fields_by_name['value'].message_type = _FEEDBACKVALUE
...
_ENTRY.fields_by_name['input']._options = None
_ENTRY.fields_by_name['true_values']._options = None
