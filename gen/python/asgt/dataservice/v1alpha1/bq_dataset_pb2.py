...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='asgt/dataservice/v1alpha1/bq_dataset.proto',
  package='asgt.dataservice.v1alpha1',
  syntax='proto3',
  serialized_options=_b('Z\013dataservice'),
  serialized_pb=_b('\n*asgt/dataservice/v1alpha1/bq_dataset.proto\x12\x19\x61sgt.dataservice.v1alpha1\x1a asgt/type/retention_policy.proto\x1a\x1cgen_bq_schema/bq_field.proto\x1a\x1cgen_bq_schema/bq_table.proto\"\xac\x02\n\x07\x44\x61taset\x12\x17\n\x08\x63onsumer\x18\x01 \x01(\tB\x05\xea?\x02\x08\x01\x12\x13\n\x04name\x18\x02 \x01(\tB\x05\xea?\x02\x08\x01\x12<\n\x04type\x18\x03 \x01(\x0e\x32\'.asgt.dataservice.v1alpha1.Dataset.TypeB\x05\xea?\x02\x08\x01\x12\x0f\n\x07targets\x18\x04 \x03(\t\x12;\n\x10retention_policy\x18\x05 \x01(\x0b\x32\x1a.asgt.type.RetentionPolicyB\x05\xea?\x02\x08\x01\x12\x13\n\x04hash\x18\x06 \x01(\tB\x05\xea?\x02\x08\x01\"C\n\x04Type\x12\x14\n\x10\x42\x41NK_TRANSACTION\x10\x00\x12\x13\n\x0fSCANNED_INVOICE\x10\x01\x12\x10\n\x0cINVOICE_LINE\x10\x02:\r\xea?\n\n\x08\x64\x61tasetsB\rZ\x0b\x64\x61taserviceb\x06proto3')
  ,
  dependencies=[asgt_dot_type_dot_retention__policy__pb2.DESCRIPTOR,gen__bq__schema_dot_bq__field__pb2.DESCRIPTOR,gen__bq__schema_dot_bq__table__pb2.DESCRIPTOR,])
...
_DATASET_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='BANK_TRANSACTION', index=0, number=0,
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INVOICE_LINE', index=2, number=2,
      serialized_options=None,
      type=None),
  ],
...
Dataset = _reflection.GeneratedProtocolMessageType('Dataset', (_message.Message,), dict(
  DESCRIPTOR = _DATASET,
  __module__ = 'asgt.dataservice.v1alpha1.bq_dataset_pb2'
