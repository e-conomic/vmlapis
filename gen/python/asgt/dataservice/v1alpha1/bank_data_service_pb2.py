...
_BANKENTRYINPUT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='targets', full_name='asgt.dataservice.v1alpha1.BankEntryInput.targets', index=1,
...
_BANKENTRYINPUT.fields_by_name['targets'].message_type = asgt_dot_type_dot_target__label__pb2._TARGETLABEL
