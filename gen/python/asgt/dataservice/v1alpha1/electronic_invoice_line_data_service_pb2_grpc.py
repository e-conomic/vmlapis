...
class ElectronicInvoiceLineDataServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetElectronicInvoiceLineInfo = channel.unary_unary(
...
class ElectronicInvoiceLineDataServiceServicer(object):
  ...
  def GetElectronicInvoiceLineInfo(self, request, context):
    # missing associated documentation comment in .proto file
    pass
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
...
def add_ElectronicInvoiceLineDataServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'GetElectronicInvoiceLineInfo': grpc.unary_unary_rpc_method_handler(
          servicer.GetElectronicInvoiceLineInfo,
