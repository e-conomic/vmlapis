...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SUGGESTERSERVICE.methods_by_name['Suggest']._serialized_options = b'\202\323\344\223\002(\"#/v2/datasets/{dataset_name}:suggest:\001*'
  _SUGGESTERSERVICE.methods_by_name['BatchSuggest']._options = None
  _SUGGESTERSERVICE.methods_by_name['BatchSuggest']._serialized_options = b'\202\323\344\223\002-\"(/v2/datasets/{dataset_name}:batchSuggest:\001*'
  _SUGGESTERSERVICE.methods_by_name['ModelBatchSuggest']._options = None
  _SUGGESTERSERVICE.methods_by_name['ModelBatchSuggest']._serialized_options = b'\202\323\344\223\0023\"./v2/datasets/{dataset_name}/model:batchSuggest:\001*'
