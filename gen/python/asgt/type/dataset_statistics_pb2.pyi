...
class DatasetStatistics(_message.Message):
    __slots__ = ["lexical_diversity_split_on_space", "lexical_diversity_split_on_special", "percent_digits", "percent_duplicates_in_dataset", "percent_empty_strings", "percent_letters", "percent_pure_numbers_remove_spaces", "percent_pure_numbers_remove_special", "percent_special_characters"]
