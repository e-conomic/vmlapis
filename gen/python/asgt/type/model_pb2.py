...
_MODEL_INPUTTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='TENSORS', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EXAMPLES', index=1, number=1,
      serialized_options=None,
      type=None),
  ],
