...
class Model(_message.Message):
    __slots__ = ["version", "created_at", "dataset_size", "training_size", "confidence_scores", "input_type", "dataset_type", "model_files", "confidence_thresholds", "target_confidence_thresholds"]
    ...
    TARGET_CONFIDENCE_THRESHOLDS_FIELD_NUMBER: _ClassVar[int]
    version: int
    ...
    target_confidence_thresholds: _containers.RepeatedCompositeFieldContainer[_prediction_pb2.Confidence]
    def __init__(self, version: _Optional[int] = ..., created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., dataset_size: _Optional[int] = ..., training_size: _Optional[int] = ..., confidence_scores: _Optional[_Iterable[_Union[_target_metrics_pb2.TargetMetrics, _Mapping]]] = ..., input_type: _Optional[_Union[Model.InputType, str]] = ..., dataset_type: _Optional[str] = ..., model_files: _Optional[_Iterable[_Union[_model_file_pb2.ModelFile, _Mapping]]] = ..., confidence_thresholds: _Optional[_Iterable[_Union[_prediction_pb2.Confidence, _Mapping]]] = ..., target_confidence_thresholds: _Optional[_Iterable[_Union[_prediction_pb2.Confidence, _Mapping]]] = ...) -> None: ...
