...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return ai.visma.google.api.HttpbodyProto.internal_static_google_api_HttpBody_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            ai.visma.google.api.HttpBody.class, ai.visma.google.api.HttpBody.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof ai.visma.google.api.HttpBody)) {
      return super.equals(obj);
    }
    ai.visma.google.api.HttpBody other = (ai.visma.google.api.HttpBody) obj;
  ...
  public static ai.visma.google.api.HttpBody parseFrom(
  ...
  public static ai.visma.google.api.HttpBody parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static ai.visma.google.api.HttpBody parseFrom(
  ...
  public static ai.visma.google.api.HttpBody parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(ai.visma.google.api.HttpBody prototype) {
  ...
  public static final class Builder extends
      ...
      ai.visma.google.api.HttpBodyOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ai.visma.google.api.HttpbodyProto.internal_static_google_api_HttpBody_descriptor;
    }
    ...
    // Construct using ai.visma.google.api.HttpBody.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public ai.visma.google.api.HttpBody getDefaultInstanceForType() {
      return ai.visma.google.api.HttpBody.getDefaultInstance();
    }

    @java.lang.Override
    public ai.visma.google.api.HttpBody build() {
      ai.visma.google.api.HttpBody result = buildPartial();
    ...
    @java.lang.Override
    public ai.visma.google.api.HttpBody buildPartial() {
      ai.visma.google.api.HttpBody result = new ai.visma.google.api.HttpBody(this);
    ...
    private void buildPartialRepeatedFields(ai.visma.google.api.HttpBody result) {
      if (extensionsBuilder_ == null) {
    ...
    private void buildPartial0(ai.visma.google.api.HttpBody result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof ai.visma.google.api.HttpBody) {
        return mergeFrom((ai.visma.google.api.HttpBody)other);
      } else {
    ...
    public Builder mergeFrom(ai.visma.google.api.HttpBody other) {
      if (other == ai.visma.google.api.HttpBody.getDefaultInstance()) return this;
  ...
  private static final ai.visma.google.api.HttpBody DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ai.visma.google.api.HttpBody();
  }

  public static ai.visma.google.api.HttpBody getDefaultInstance() {
