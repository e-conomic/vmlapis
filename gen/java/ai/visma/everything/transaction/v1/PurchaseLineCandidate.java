 ...
 * </pre>
 *
 * Protobuf type {@code everything.transaction.v1.PurchaseLineCandidate}
 */
public final class PurchaseLineCandidate extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:everything.transaction.v1.PurchaseLineCandidate)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ai.visma.everything.transaction.v1.TransactionProto.internal_static_everything_transaction_v1_PurchaseLineCandidate_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return ai.visma.everything.transaction.v1.TransactionProto.internal_static_everything_transaction_v1_PurchaseLineCandidate_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            ai.visma.everything.transaction.v1.PurchaseLineCandidate.class, ai.visma.everything.transaction.v1.PurchaseLineCandidate.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof ai.visma.everything.transaction.v1.PurchaseLineCandidate)) {
      return super.equals(obj);
    }
    ai.visma.everything.transaction.v1.PurchaseLineCandidate other = (ai.visma.everything.transaction.v1.PurchaseLineCandidate) obj;
  ...
  public static ai.visma.everything.transaction.v1.PurchaseLineCandidate parseFrom(
  ...
  public static ai.visma.everything.transaction.v1.PurchaseLineCandidate parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static ai.visma.everything.transaction.v1.PurchaseLineCandidate parseFrom(
  ...
  public static ai.visma.everything.transaction.v1.PurchaseLineCandidate parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static ai.visma.everything.transaction.v1.PurchaseLineCandidate parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static ai.visma.everything.transaction.v1.PurchaseLineCandidate parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(ai.visma.everything.transaction.v1.PurchaseLineCandidate prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:everything.transaction.v1.PurchaseLineCandidate)
      ai.visma.everything.transaction.v1.PurchaseLineCandidateOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ai.visma.everything.transaction.v1.TransactionProto.internal_static_everything_transaction_v1_PurchaseLineCandidate_descriptor;
    }
    ...
    // Construct using ai.visma.everything.transaction.v1.PurchaseLineCandidate.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public ai.visma.everything.transaction.v1.PurchaseLineCandidate getDefaultInstanceForType() {
      return ai.visma.everything.transaction.v1.PurchaseLineCandidate.getDefaultInstance();
    }

    @java.lang.Override
    public ai.visma.everything.transaction.v1.PurchaseLineCandidate build() {
      ai.visma.everything.transaction.v1.PurchaseLineCandidate result = buildPartial();
    ...
    @java.lang.Override
    public ai.visma.everything.transaction.v1.PurchaseLineCandidate buildPartial() {
      ai.visma.everything.transaction.v1.PurchaseLineCandidate result = new ai.visma.everything.transaction.v1.PurchaseLineCandidate(this);
    ...
    private void buildPartialRepeatedFields(ai.visma.everything.transaction.v1.PurchaseLineCandidate result) {
      if (purchaseLineCandidateBuilder_ == null) {
    ...
    private void buildPartial0(ai.visma.everything.transaction.v1.PurchaseLineCandidate result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof ai.visma.everything.transaction.v1.PurchaseLineCandidate) {
        return mergeFrom((ai.visma.everything.transaction.v1.PurchaseLineCandidate)other);
      } else {
    ...
    public Builder mergeFrom(ai.visma.everything.transaction.v1.PurchaseLineCandidate other) {
      if (other == ai.visma.everything.transaction.v1.PurchaseLineCandidate.getDefaultInstance()) return this;
      if (purchaseLineCandidateBuilder_ == null) {
    ...
    // @@protoc_insertion_point(builder_scope:everything.transaction.v1.PurchaseLineCandidate)
  }

  // @@protoc_insertion_point(class_scope:everything.transaction.v1.PurchaseLineCandidate)
  private static final ai.visma.everything.transaction.v1.PurchaseLineCandidate DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ai.visma.everything.transaction.v1.PurchaseLineCandidate();
  }

  public static ai.visma.everything.transaction.v1.PurchaseLineCandidate getDefaultInstance() {
