...
import * as ssn_type_example_pb from '../../../ssn/type/example_pb';
...
export class FeatureGenResponse extends jspb.Message {
  getExample(): ssn_type_example_pb.Example | undefined;
  setExample(value?: ssn_type_example_pb.Example): FeatureGenResponse;
  hasExample(): boolean;
...
export namespace FeatureGenResponse {
  export type AsObject = {
    example?: ssn_type_example_pb.Example.AsObject,
  }
}

export class PredictRequest extends jspb.Message {
  getExample(): ssn_type_example_pb.Example | undefined;
  setExample(value?: ssn_type_example_pb.Example): PredictRequest;
  hasExample(): boolean;
