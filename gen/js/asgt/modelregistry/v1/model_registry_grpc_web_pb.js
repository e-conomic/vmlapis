 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.asgt.modelregistry.v1.RegisterQueryStatsRequest,
 *   !proto.google.protobuf.Empty>}
 */
const methodDescriptor_ModelRegistry_RegisterQueryStats = new grpc.web.MethodDescriptor(
  '/asgt.modelregistry.v1.ModelRegistry/RegisterQueryStats',
  grpc.web.MethodType.UNARY,
  proto.asgt.modelregistry.v1.RegisterQueryStatsRequest,
  google_protobuf_empty_pb.Empty,
  /**
   * @param {!proto.asgt.modelregistry.v1.RegisterQueryStatsRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
 ...
 *   !proto.google.protobuf.Empty>}
 */
const methodInfo_ModelRegistry_RegisterQueryStats = new grpc.web.AbstractClientBase.MethodInfo(
  google_protobuf_empty_pb.Empty,
  /**
   * @param {!proto.asgt.modelregistry.v1.RegisterQueryStatsRequest} request
   * @return {!Uint8Array}
...
/**
 * @param {!proto.asgt.modelregistry.v1.RegisterQueryStatsRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.google.protobuf.Empty)}
 ...
 *     The XHR Node Readable Stream
 */
proto.asgt.modelregistry.v1.ModelRegistryClient.prototype.registerQueryStats =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/asgt.modelregistry.v1.ModelRegistry/RegisterQueryStats',
      request,
      metadata || {},
      methodDescriptor_ModelRegistry_RegisterQueryStats,
      callback);
};
 ...
 *     A native promise that resolves to the response
 */
proto.asgt.modelregistry.v1.ModelRegistryPromiseClient.prototype.registerQueryStats =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/asgt.modelregistry.v1.ModelRegistry/RegisterQueryStats',
      request,
