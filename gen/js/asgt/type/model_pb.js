...
goog.exportSymbol('proto.asgt.type.Model.InputTypes', null, global);
...
proto.asgt.type.Model.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    inputTypes: jspb.Message.getFieldWithDefault(msg, 8, 0)
  };
...
proto.asgt.type.Model.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      break;
    case 8:
      var value = /** @type {!proto.asgt.type.Model.InputTypes} */ (reader.readEnum());
      msg.setInputTypes(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @enum {number}
 */
proto.asgt.type.Model.InputTypes = {
  EXAMPLES: 0,
  TENSORS: 1
};
...
/**
 * optional InputTypes input_types = 8;
 * @return {!proto.asgt.type.Model.InputTypes}
 */
proto.asgt.type.Model.prototype.getInputTypes = function() {
  return /** @type {!proto.asgt.type.Model.InputTypes} */ (jspb.Message.getFieldWithDefault(this, 8, 0));
};


/** @param {!proto.asgt.type.Model.InputTypes} value */
proto.asgt.type.Model.prototype.setInputTypes = function(value) {
