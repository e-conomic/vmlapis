...
goog.exportSymbol('proto.asgt.type.Prediction.Candidate', null, global);
 ...
 * @const
 */
proto.asgt.type.Prediction.repeatedFields_ = [2];
...
proto.asgt.type.Prediction.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.asgt.type.Prediction.Candidate.toObject, includeInstance)
  };
...
proto.asgt.type.Prediction.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.asgt.type.Prediction.Candidate;
      reader.readMessage(value,proto.asgt.type.Prediction.Candidate.deserializeBinaryFromReader);
...
proto.asgt.type.Prediction.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.asgt.type.Prediction.Candidate.serializeBinaryToWriter
    );
  }
};
 ...
 * @constructor
 */
proto.asgt.type.Prediction.Candidate = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.asgt.type.Prediction.Candidate, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.asgt.type.Prediction.Candidate.displayName = 'proto.asgt.type.Prediction.Candidate';
}
 ...
 * @return {!Object}
 */
proto.asgt.type.Prediction.Candidate.prototype.toObject = function(opt_includeInstance) {
  return proto.asgt.type.Prediction.Candidate.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.asgt.type.Prediction.Candidate} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.asgt.type.Prediction.Candidate.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.asgt.type.Prediction.Candidate}
 */
proto.asgt.type.Prediction.Candidate.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.asgt.type.Prediction.Candidate;
  return proto.asgt.type.Prediction.Candidate.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.asgt.type.Prediction.Candidate} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.asgt.type.Prediction.Candidate}
 */
proto.asgt.type.Prediction.Candidate.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.asgt.type.Prediction.Candidate.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.asgt.type.Prediction.Candidate.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.asgt.type.Prediction.Candidate} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.asgt.type.Prediction.Candidate.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getLabel();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.asgt.type.Prediction.Candidate.prototype.getLabel = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.asgt.type.Prediction.Candidate.prototype.setLabel = function(value) {
 ...
 * @return {?proto.asgt.type.Confidence}
 */
proto.asgt.type.Prediction.Candidate.prototype.getConfidence = function() {
...
proto.asgt.type.Prediction.Candidate.prototype.setConfidence = function(value) {
  jspb.Message.setWrapperField(this, 2, value);
};


proto.asgt.type.Prediction.Candidate.prototype.clearConfidence = function() {
 ...
 * @return {!boolean}
 */
proto.asgt.type.Prediction.Candidate.prototype.hasConfidence = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {string}
 */
proto.asgt.type.Prediction.prototype.getTarget = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.asgt.type.Prediction.prototype.setTarget = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Array<!proto.asgt.type.Prediction.Candidate>}
 */
proto.asgt.type.Prediction.prototype.getCandidatesList = function() {
  return /** @type{!Array<!proto.asgt.type.Prediction.Candidate>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.asgt.type.Prediction.Candidate, 2));
};


/** @param {!Array<!proto.asgt.type.Prediction.Candidate>} value */
proto.asgt.type.Prediction.prototype.setCandidatesList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 2, value);
};


/**
 * @param {!proto.asgt.type.Prediction.Candidate=} opt_value
 * @param {number=} opt_index
 * @return {!proto.asgt.type.Prediction.Candidate}
 */
proto.asgt.type.Prediction.prototype.addCandidates = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.asgt.type.Prediction.Candidate, opt_index);
};


proto.asgt.type.Prediction.prototype.clearCandidatesList = function() {
