...
proto.asgt.type.TrainStatistics.toObject = function(includeInstance, msg) {
  var f, obj = {
    featureCount: jspb.Message.getFloatingPointFieldWithDefault(msg, 1, 0.0),
    featureNamesList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? undefined : f,
    targetNamesList: (f = jspb.Message.getRepeatedField(msg, 3)) == null ? undefined : f,
    ...
    similarityIndex: jspb.Message.getFloatingPointFieldWithDefault(msg, 6, 0.0)
  };
...
proto.asgt.type.TrainStatistics.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.asgt.type.TrainStatistics.InformationGain.deserializeBinaryFromReader, "", new proto.asgt.type.TrainStatistics.InformationGain());
         });
      break;
    case 6:
      var value = /** @type {number} */ (reader.readFloat());
 ...
 * @return {!proto.asgt.type.TrainStatistics.InformationGain} returns this
 */
...
proto.asgt.type.TrainStatistics.prototype.clearTargetNamesList = function() {
  return this.setTargetNamesList([]);
};
