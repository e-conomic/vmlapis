...
proto.asgt.dataservice.v1alpha1.Entry.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    predictionValuesMap: (f = msg.getPredictionValuesMap()) ? f.toObject(includeInstance, proto.asgt.dataservice.v1alpha1.FeedbackValue.toObject) : [],
...
proto.asgt.dataservice.v1alpha1.Entry.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(7, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.asgt.dataservice.v1alpha1.FeedbackValue.serializeBinaryToWriter);
  }
