 ...
 */
const methodDescriptor_BankDataService_GetBankInfo = new grpc.web.MethodDescriptor(
 ...
 *   !proto.asgt.dataservice.v1alpha1.GetInfoResponse>}
 */
const methodInfo_BankDataService_GetBankInfo = new grpc.web.AbstractClientBase.MethodInfo(
  asgt_dataservice_v1alpha1_info_pb.GetInfoResponse,
  /**
   * @param {!proto.asgt.dataservice.v1alpha1.GetInfoRequest} request
   * @return {!Uint8Array}
 ...
 *     The XHR Node Readable Stream
 */
proto.asgt.dataservice.v1alpha1.BankDataServiceClient.prototype.getBankInfo =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/asgt.dataservice.v1alpha1.BankDataService/GetBankInfo',
      request,
      metadata || {},
      methodDescriptor_BankDataService_GetBankInfo,
      callback);
};
 ...
 *     A native promise that resolves to the response
 */
proto.asgt.dataservice.v1alpha1.BankDataServicePromiseClient.prototype.getBankInfo =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/asgt.dataservice.v1alpha1.BankDataService/GetBankInfo',
      request,
