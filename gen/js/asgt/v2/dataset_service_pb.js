...
goog.exportSymbol('proto.asgt.v2.DuplicateDatasetRequest', null, global);
 ...
 * @constructor
 */
proto.asgt.v2.DuplicateDatasetRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.asgt.v2.DuplicateDatasetRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.asgt.v2.DuplicateDatasetRequest.displayName = 'proto.asgt.v2.DuplicateDatasetRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.asgt.v2.DuplicateDatasetRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.asgt.v2.DuplicateDatasetRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.asgt.v2.DuplicateDatasetRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.asgt.v2.DuplicateDatasetRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    datasetName: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.asgt.v2.DuplicateDatasetRequest}
 */
proto.asgt.v2.DuplicateDatasetRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.asgt.v2.DuplicateDatasetRequest;
  return proto.asgt.v2.DuplicateDatasetRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.asgt.v2.DuplicateDatasetRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.asgt.v2.DuplicateDatasetRequest}
 */
proto.asgt.v2.DuplicateDatasetRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.asgt.v2.DuplicateDatasetRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.asgt.v2.DuplicateDatasetRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.asgt.v2.DuplicateDatasetRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.asgt.v2.DuplicateDatasetRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDatasetName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.asgt.v2.DuplicateDatasetRequest.prototype.getDatasetName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.asgt.v2.DuplicateDatasetRequest} returns this
 */
proto.asgt.v2.DuplicateDatasetRequest.prototype.setDatasetName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.asgt.v2.DuplicateDatasetRequest.prototype.getDatasetType = function() {
 ...
 * @return {!proto.asgt.v2.DuplicateDatasetRequest} returns this
 */
proto.asgt.v2.DuplicateDatasetRequest.prototype.setDatasetType = function(value) {
 ...
 * @return {string}
 */
proto.asgt.v2.DuplicateDatasetRequest.prototype.getProjectName = function() {
 ...
 * @return {!proto.asgt.v2.DuplicateDatasetRequest} returns this
 */
proto.asgt.v2.DuplicateDatasetRequest.prototype.setProjectName = function(value) {
