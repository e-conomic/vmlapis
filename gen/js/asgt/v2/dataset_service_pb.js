...
goog.exportSymbol('proto.asgt.v2.GetTrainingByIDRequest', null, global);
 ...
 * @constructor
 */
proto.asgt.v2.GetTrainingByIDRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.asgt.v2.GetTrainingByIDRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.asgt.v2.GetTrainingByIDRequest.displayName = 'proto.asgt.v2.GetTrainingByIDRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.asgt.v2.GetTrainingByIDRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.asgt.v2.GetTrainingByIDRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.asgt.v2.GetTrainingByIDRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.asgt.v2.GetTrainingByIDRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    trainingId: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.asgt.v2.GetTrainingByIDRequest}
 */
proto.asgt.v2.GetTrainingByIDRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.asgt.v2.GetTrainingByIDRequest;
  return proto.asgt.v2.GetTrainingByIDRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.asgt.v2.GetTrainingByIDRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.asgt.v2.GetTrainingByIDRequest}
 */
proto.asgt.v2.GetTrainingByIDRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.asgt.v2.GetTrainingByIDRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.asgt.v2.GetTrainingByIDRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.asgt.v2.GetTrainingByIDRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.asgt.v2.GetTrainingByIDRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTrainingId();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
...
/**
 * optional string training_id = 1;
 * @return {string}
 */
proto.asgt.v2.GetTrainingByIDRequest.prototype.getTrainingId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.asgt.v2.GetTrainingByIDRequest} returns this
 */
proto.asgt.v2.GetTrainingByIDRequest.prototype.setTrainingId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
