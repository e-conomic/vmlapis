...
type DatasetServiceClient interface {
	...
	// provided data.
	CreateOrUpdateDataset(ctx context.Context, in *CreateOrUpdateDatasetRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *datasetServiceClient) CreateOrUpdateDataset(ctx context.Context, in *CreateOrUpdateDatasetRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type DatasetServiceServer interface {
	...
	// Create a new dataset. If a dataset with such name already exsits, it will be updated with the
	// provided data.
	CreateOrUpdateDataset(context.Context, *CreateOrUpdateDatasetRequest) (*empty.Empty, error)
	// Delete a dataset with the specified name.
...
func (UnimplementedDatasetServiceServer) CreateOrUpdateDataset(context.Context, *CreateOrUpdateDatasetRequest) (*empty.Empty, error) {
