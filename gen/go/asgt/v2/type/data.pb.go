...
type InvoiceLine struct {
	...
	ItemId string `protobuf:"bytes,1,opt,name=item_id,json=itemId,proto3" json:"item_id,omitempty"` // NOTE(lku) Can't do much - has non-english letters and even slashes
	...
	CustomerRef string `protobuf:"bytes,5,opt,name=customer_ref,json=customerRef,proto3" json:"customer_ref,omitempty"` // NOTE(lku) Can't do much - has non-english letters and even slashes
...
func (x *InvoiceLine) GetIssueDate() *timestamp.Timestamp {
	if x != nil {
		return x.IssueDate
	}
	return nil
...
type Supplier struct {
	...
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"` // NOTE(lku) has non-english letters and even slashes
