...
type Data struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to DataStructure:
	//
	//	*Data_Transaction
	//	*Data_Invoice
	//	*Data_InvoiceLine
...
func (x *Data) GetDataStructure() isData_DataStructure {
	if x != nil {
...
func (x *Data) GetTransaction() *Transaction {
	if x != nil {
		if x, ok := x.DataStructure.(*Data_Transaction); ok {
...
func (x *Data) GetInvoice() *Invoice {
	if x != nil {
		if x, ok := x.DataStructure.(*Data_Invoice); ok {
			return x.Invoice
		}
	}
	return nil
...
func (x *Data) GetInvoiceLine() *InvoiceLine {
	if x != nil {
		if x, ok := x.DataStructure.(*Data_InvoiceLine); ok {
...
var file_asgt_v2_type_data_proto_rawDesc = string([]byte{
...
var (
	...
	file_asgt_v2_type_data_proto_rawDescData []byte
)

func file_asgt_v2_type_data_proto_rawDescGZIP() []byte {
	file_asgt_v2_type_data_proto_rawDescOnce.Do(func() {
		file_asgt_v2_type_data_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_asgt_v2_type_data_proto_rawDesc), len(file_asgt_v2_type_data_proto_rawDesc)))
	})
	return file_asgt_v2_type_data_proto_rawDescData
}

var file_asgt_v2_type_data_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_asgt_v2_type_data_proto_goTypes = []any{
...
func file_asgt_v2_type_data_proto_init() {
	...
	file_asgt_v2_type_data_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_asgt_v2_type_data_proto_rawDesc), len(file_asgt_v2_type_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
