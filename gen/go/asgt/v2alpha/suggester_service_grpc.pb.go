...
func (c *suggesterServiceClient) Suggest(ctx context.Context, in *SuggestRequest, opts ...grpc.CallOption) (*SuggestResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/asgt.v2alpha.SuggesterService/Suggest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *suggesterServiceClient) BatchSuggest(ctx context.Context, in *BatchSuggestRequest, opts ...grpc.CallOption) (*BatchSuggestResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/asgt.v2alpha.SuggesterService/BatchSuggest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *suggesterServiceClient) ModelBatchSuggest(ctx context.Context, in *BatchSuggestRequest, opts ...grpc.CallOption) (*BatchSuggestResponse, error) {
	out := new(BatchSuggestResponse)
	err := c.cc.Invoke(ctx, "/asgt.v2alpha.SuggesterService/ModelBatchSuggest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations must embed UnimplementedSuggesterServiceServer
...
// UnimplementedSuggesterServiceServer must be embedded to have forward compatible implementations.
...
func (*UnimplementedSuggesterServiceServer) mustEmbedUnimplementedSuggesterServiceServer() {}

func RegisterSuggesterServiceServer(s *grpc.Server, srv SuggesterServiceServer) {
	s.RegisterService(&_SuggesterService_serviceDesc, srv)
}
...
func _SuggesterService_Suggest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/asgt.v2alpha.SuggesterService/Suggest",
	}
...
func _SuggesterService_BatchSuggest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/asgt.v2alpha.SuggesterService/BatchSuggest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SuggesterService_ModelBatchSuggest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/asgt.v2alpha.SuggesterService/ModelBatchSuggest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _SuggesterService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "asgt.v2alpha.SuggesterService",
	...
	Metadata: "asgt/v2alpha/suggester_service.proto",
}
