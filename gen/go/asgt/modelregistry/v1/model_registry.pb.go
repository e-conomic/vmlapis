...
type RegisterModelRequest struct {
	...
	Metrics                      map[string]int32                       `protobuf:"bytes,4,rep,name=metrics,proto3" json:"metrics,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	...
	TargetToConfidenceThresholds map[string]*_type.ConfidenceThresholds `protobuf:"bytes,10,rep,name=target_to_confidence_thresholds,json=targetToConfidenceThresholds,proto3" json:"target_to_confidence_thresholds,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
var file_asgt_modelregistry_v1_model_registry_proto_rawDesc = string([]byte{
...
var (
	...
	file_asgt_modelregistry_v1_model_registry_proto_rawDescData []byte
)
...
func file_asgt_modelregistry_v1_model_registry_proto_rawDescGZIP() []byte {
	file_asgt_modelregistry_v1_model_registry_proto_rawDescOnce.Do(func() {
		file_asgt_modelregistry_v1_model_registry_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_asgt_modelregistry_v1_model_registry_proto_rawDesc), len(file_asgt_modelregistry_v1_model_registry_proto_rawDesc)))
	})
...
var file_asgt_modelregistry_v1_model_registry_proto_goTypes = []any{
...
func file_asgt_modelregistry_v1_model_registry_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_asgt_modelregistry_v1_model_registry_proto_rawDesc), len(file_asgt_modelregistry_v1_model_registry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
