...
type TrainStatistics struct {
	state                protoimpl.MessageState   `protogen:"open.v1"`
	TargetStatsByTarget  map[string]*TargetStats  `protobuf:"bytes,1,rep,name=target_stats_by_target,json=targetStatsByTarget,proto3" json:"target_stats_by_target,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`    // target statistics for each target (classification task)
	FeatureStatsByTarget map[string]*FeatureStats `protobuf:"bytes,2,rep,name=feature_stats_by_target,json=featureStatsByTarget,proto3" json:"feature_stats_by_target,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // feature statistics for each target (classification task)
...
var file_asgt_type_train_statistics_proto_rawDesc = string([]byte{
...
var (
	...
	file_asgt_type_train_statistics_proto_rawDescData []byte
)

func file_asgt_type_train_statistics_proto_rawDescGZIP() []byte {
	file_asgt_type_train_statistics_proto_rawDescOnce.Do(func() {
		file_asgt_type_train_statistics_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_asgt_type_train_statistics_proto_rawDesc), len(file_asgt_type_train_statistics_proto_rawDesc)))
	})
...
var file_asgt_type_train_statistics_proto_goTypes = []any{
...
func file_asgt_type_train_statistics_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_asgt_type_train_statistics_proto_rawDesc), len(file_asgt_type_train_statistics_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
