...
var file_asgt_type_sample_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x73, 0x42, 0x38, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var (
	...
	file_asgt_type_sample_proto_rawDescData = file_asgt_type_sample_proto_rawDesc
)

func file_asgt_type_sample_proto_rawDescGZIP() []byte {
	file_asgt_type_sample_proto_rawDescOnce.Do(func() {
		file_asgt_type_sample_proto_rawDescData = protoimpl.X.CompressGZIP(file_asgt_type_sample_proto_rawDescData)
	})
	return file_asgt_type_sample_proto_rawDescData
}

var file_asgt_type_sample_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_asgt_type_sample_proto_goTypes = []interface{}{
...
func file_asgt_type_sample_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_asgt_type_sample_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Sample); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_asgt_type_sample_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_asgt_type_sample_proto_rawDesc = nil
