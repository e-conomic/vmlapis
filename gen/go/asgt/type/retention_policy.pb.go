...
var file_asgt_type_retention_policy_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x07, 0x6d, 0x61, 0x78, 0x44, 0x61, 0x79, 0x73, 0x42, 0x38, 0x5a, 0x36, 0x67,
...
var (
	...
	file_asgt_type_retention_policy_proto_rawDescData = file_asgt_type_retention_policy_proto_rawDesc
)

func file_asgt_type_retention_policy_proto_rawDescGZIP() []byte {
	file_asgt_type_retention_policy_proto_rawDescOnce.Do(func() {
		file_asgt_type_retention_policy_proto_rawDescData = protoimpl.X.CompressGZIP(file_asgt_type_retention_policy_proto_rawDescData)
	})
...
var file_asgt_type_retention_policy_proto_goTypes = []interface{}{
...
func file_asgt_type_retention_policy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_asgt_type_retention_policy_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_asgt_type_retention_policy_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_asgt_type_retention_policy_proto_rawDesc = nil
