...
var file_asgt_type_target_value_proto_rawDesc = string([]byte{
...
var (
	...
	file_asgt_type_target_value_proto_rawDescData []byte
)

func file_asgt_type_target_value_proto_rawDescGZIP() []byte {
	file_asgt_type_target_value_proto_rawDescOnce.Do(func() {
		file_asgt_type_target_value_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_asgt_type_target_value_proto_rawDesc), len(file_asgt_type_target_value_proto_rawDesc)))
	})
...
var file_asgt_type_target_value_proto_goTypes = []any{
...
func file_asgt_type_target_value_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_asgt_type_target_value_proto_rawDesc), len(file_asgt_type_target_value_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
