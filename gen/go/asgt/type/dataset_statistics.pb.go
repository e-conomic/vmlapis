...
type DatasetStatistics struct {
	...
	LexicalDiversitySplitOnSpace    float32 `protobuf:"fixed32,1,opt,name=lexical_diversity_split_on_space,json=lexicalDiversitySplitOnSpace,proto3" json:"lexical_diversity_split_on_space,omitempty"`          // lexical diversity of the dataset split on space
	LexicalDiversitySplitOnSpecial  float32 `protobuf:"fixed32,2,opt,name=lexical_diversity_split_on_special,json=lexicalDiversitySplitOnSpecial,proto3" json:"lexical_diversity_split_on_special,omitempty"`    // lexical diversity of the dataset split on special characters
	PercentEmptyStrings             float32 `protobuf:"fixed32,3,opt,name=percent_empty_strings,json=percentEmptyStrings,proto3" json:"percent_empty_strings,omitempty"`                                         // percentage of empty strings in the dataset
	PercentPureNumbersRemoveSpaces  float32 `protobuf:"fixed32,4,opt,name=percent_pure_numbers_remove_spaces,json=percentPureNumbersRemoveSpaces,proto3" json:"percent_pure_numbers_remove_spaces,omitempty"`    // percentage of pure numbers in the dataset after removing spaces
	PercentPureNumbersRemoveSpecial float32 `protobuf:"fixed32,5,opt,name=percent_pure_numbers_remove_special,json=percentPureNumbersRemoveSpecial,proto3" json:"percent_pure_numbers_remove_special,omitempty"` // percentage of pure numbers in the dataset after removing spaces and special characters
	PercentSpecialCharacters        float32 `protobuf:"fixed32,6,opt,name=percent_special_characters,json=percentSpecialCharacters,proto3" json:"percent_special_characters,omitempty"`                          // percentage of special characters in the dataset
	PercentDigits                   float32 `protobuf:"fixed32,7,opt,name=percent_digits,json=percentDigits,proto3" json:"percent_digits,omitempty"`                                                             // percentage of digits in the dataset
	PercentLetters                  float32 `protobuf:"fixed32,8,opt,name=percent_letters,json=percentLetters,proto3" json:"percent_letters,omitempty"`                                                          // percentage of letters in the dataset
	PercentDuplicatesInDataset      float32 `protobuf:"fixed32,9,opt,name=percent_duplicates_in_dataset,json=percentDuplicatesInDataset,proto3" json:"percent_duplicates_in_dataset,omitempty"`                  // percentage of duplicates in the dataset
}
...
var file_asgt_type_dataset_statistics_proto_rawDesc = []byte{
	...
	0xc6, 0x04, 0x0a, 0x11, 0x44, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x69,
	...
	0x5f, 0x6f, 0x6e, 0x5f, 0x73, 0x70, 0x61, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x02, 0x52,
	...
	0x69, 0x61, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x52, 0x1e, 0x6c, 0x65, 0x78, 0x69, 0x63,
	...
	0x67, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x02, 0x52, 0x13, 0x70, 0x65, 0x72, 0x63, 0x65, 0x6e,
	...
	0x63, 0x65, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x02, 0x52, 0x1e, 0x70, 0x65, 0x72, 0x63, 0x65,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x02, 0x52, 0x1f, 0x70, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x50,
	...
	0x63, 0x74, 0x65, 0x72, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x02, 0x52, 0x18, 0x70, 0x65, 0x72,
	...
	0x5f, 0x64, 0x69, 0x67, 0x69, 0x74, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0d, 0x70,
	...
	0x08, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0e, 0x70, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x4c, 0x65,
	...
	0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x18, 0x09, 0x20, 0x01, 0x28, 0x02, 0x52, 0x1a, 0x70, 0x65,
	0x72, 0x63, 0x65, 0x6e, 0x74, 0x44, 0x75, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x65, 0x73, 0x49,
	0x6e, 0x44, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x42, 0x38, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68,
