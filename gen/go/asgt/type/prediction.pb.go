...
type TargetConfidence struct {
	...
	Confidence []*Confidence `protobuf:"bytes,2,rep,name=confidence,proto3" json:"confidence,omitempty"`
}

func (x *TargetConfidence) Reset() {
	*x = TargetConfidence{}
...
func (x *TargetConfidence) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TargetConfidence) ProtoMessage() {}

func (x *TargetConfidence) ProtoReflect() protoreflect.Message {
	mi := &file_asgt_type_prediction_proto_msgTypes[0]
...
// Deprecated: Use TargetConfidence.ProtoReflect.Descriptor instead.
func (*TargetConfidence) Descriptor() ([]byte, []int) {
	return file_asgt_type_prediction_proto_rawDescGZIP(), []int{0}
}

func (x *TargetConfidence) GetTargetName() string {
	if x != nil {
		return x.TargetName
	}
	return ""
...
func (x *TargetConfidence) GetConfidence() []*Confidence {
	if x != nil {
		return x.Confidence
	}
	return nil
...
func (*Prediction) Descriptor() ([]byte, []int) {
	return file_asgt_type_prediction_proto_rawDescGZIP(), []int{2}
}
...
func (*Prediction_Target) Descriptor() ([]byte, []int) {
	return file_asgt_type_prediction_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *Prediction_Target_Candidate) Reset() {
	*x = Prediction_Target_Candidate{}
	if protoimpl.UnsafeEnabled {
		mi := &file_asgt_type_prediction_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Prediction_Target_Candidate) Descriptor() ([]byte, []int) {
	return file_asgt_type_prediction_proto_rawDescGZIP(), []int{2, 0, 0}
}
...
var file_asgt_type_prediction_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x6a, 0x0a, 0x10, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x74, 0x61, 0x72,
	0x67, 0x65, 0x74, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a,
	0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x35, 0x0a, 0x0a, 0x63, 0x6f,
	0x6e, 0x66, 0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15,
	...
	,
	...
	,
...
var file_asgt_type_prediction_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_asgt_type_prediction_proto_goTypes = []interface{}{
	(Confidence_Level)(0),               // 0: asgt.type.Confidence.Level
	(*TargetConfidence)(nil),            // 1: asgt.type.TargetConfidence
	(*Confidence)(nil),                  // 2: asgt.type.Confidence
	(*Prediction)(nil),                  // 3: asgt.type.Prediction
	(*Prediction_Target)(nil),           // 4: asgt.type.Prediction.Target
	(*Prediction_Target_Candidate)(nil), // 5: asgt.type.Prediction.Target.Candidate
	(*wrapperspb.FloatValue)(nil),       // 6: google.protobuf.FloatValue
}
var file_asgt_type_prediction_proto_depIdxs = []int32{
	2, // 0: asgt.type.TargetConfidence.confidence:type_name -> asgt.type.Confidence
	0, // 1: asgt.type.Confidence.level:type_name -> asgt.type.Confidence.Level
	6, // 2: asgt.type.Confidence.value:type_name -> google.protobuf.FloatValue
	4, // 3: asgt.type.Prediction.targets:type_name -> asgt.type.Prediction.Target
	5, // 4: asgt.type.Prediction.Target.candidates:type_name -> asgt.type.Prediction.Target.Candidate
	2, // 5: asgt.type.Prediction.Target.Candidate.confidence:type_name -> asgt.type.Confidence
...
func file_asgt_type_prediction_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_asgt_type_prediction_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
