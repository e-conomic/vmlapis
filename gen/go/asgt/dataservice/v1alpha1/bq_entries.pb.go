...
func (*BankEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_bq_entries_b3a805f182f45ebe, []int{0}
}
...
func (*ElectronicInvoiceLineEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_bq_entries_b3a805f182f45ebe, []int{1}
}
...
func (*ScannedInvoiceEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_bq_entries_b3a805f182f45ebe, []int{2}
}
...
func init() {
	proto.RegisterFile("asgt/dataservice/v1alpha1/bq_entries.proto", fileDescriptor_bq_entries_b3a805f182f45ebe)
}

var fileDescriptor_bq_entries_b3a805f182f45ebe = []byte{
	// 620 bytes of a gzipped FileDescriptorProto
	,
}
