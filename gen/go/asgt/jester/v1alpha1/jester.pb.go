...
func (*SuggestionsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_jester_e907111d765dcb16, []int{0}
}
...
func (*SuggestionOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_jester_e907111d765dcb16, []int{1}
}
...
func (*ScannedInvoiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_jester_e907111d765dcb16, []int{2}
}
...
func (*ScannedInvoiceRequest_Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_jester_e907111d765dcb16, []int{2, 0}
}
...
func (*ElectronicInvoiceLineRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_jester_e907111d765dcb16, []int{3}
}
...
func (*ElectronicInvoiceLineRequest_Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_jester_e907111d765dcb16, []int{3, 0}
}
...
func (*BankRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_jester_e907111d765dcb16, []int{4}
}
...
func (*BankRequest_Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_jester_e907111d765dcb16, []int{4, 0}
}
...
func init() {
	proto.RegisterFile("asgt/jester/v1alpha1/jester.proto", fileDescriptor_jester_e907111d765dcb16)
}

var fileDescriptor_jester_e907111d765dcb16 = []byte{
	...
	,
}
