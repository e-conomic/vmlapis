...
func RegisterAccessHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AccessClient) error {
	...
	mux.Handle("POST", pattern_Access_GenerateValetKey_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Access_GenerateValetKey_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Access_GenerateValetKey_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
