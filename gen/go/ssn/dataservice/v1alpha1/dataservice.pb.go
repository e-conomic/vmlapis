...
func (*Document) Descriptor() ([]byte, []int) {
	return fileDescriptor_dataservice_8c3c9c66515ed010, []int{0}
}
...
func (*TrueValues) Descriptor() ([]byte, []int) {
	return fileDescriptor_dataservice_8c3c9c66515ed010, []int{1}
}
...
func (*CreateDocumentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_dataservice_8c3c9c66515ed010, []int{2}
}
...
func (*CreateDocumentResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dataservice_8c3c9c66515ed010, []int{3}
}
...
func (*ReadDocumentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_dataservice_8c3c9c66515ed010, []int{4}
}
...
func (*ReadDocumentResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dataservice_8c3c9c66515ed010, []int{5}
}
...
func (*PrepareFeedbackRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_dataservice_8c3c9c66515ed010, []int{6}
}
...
func (*FeedbackRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_dataservice_8c3c9c66515ed010, []int{7}
}
...
func init() {
	proto.RegisterFile("ssn/dataservice/v1alpha1/dataservice.proto", fileDescriptor_dataservice_8c3c9c66515ed010)
}

var fileDescriptor_dataservice_8c3c9c66515ed010 = []byte{
	...
	,
}
