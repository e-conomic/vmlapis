...
import fmt "fmt"
import math "math"
import v1 "github.com/e-conomic/gen/go/ssn/mlservice/v1"
import v11 "github.com/e-conomic/gen/go/ssn/ocrservice/v1"
...
func (Feature_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_scanner_b3124e160edbbb2d, []int{0, 0}
}
...
func (*Feature) Descriptor() ([]byte, []int) {
	return fileDescriptor_scanner_b3124e160edbbb2d, []int{0}
}
...
func (*ScanRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_scanner_b3124e160edbbb2d, []int{1}
}
...
func (*ScanResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_scanner_b3124e160edbbb2d, []int{2}
}
...
func (*InternalScanResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_scanner_b3124e160edbbb2d, []int{3}
}
...
func init() {
	proto.RegisterFile("ssn/scanner/v1/scanner.proto", fileDescriptor_scanner_b3124e160edbbb2d)
}

var fileDescriptor_scanner_b3124e160edbbb2d = []byte{
	// 470 bytes of a gzipped FileDescriptorProto
	,
}
