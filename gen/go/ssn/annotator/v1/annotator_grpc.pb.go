...
type DocumentAnnotatorClient interface {
	...
	Test(ctx context.Context, in *DocumentAnnotatorRequest, opts ...grpc.CallOption) (*DocumentAnnotatorResponse, error)
}
...
func (c *documentAnnotatorClient) Test(ctx context.Context, in *DocumentAnnotatorRequest, opts ...grpc.CallOption) (*DocumentAnnotatorResponse, error) {
	out := new(DocumentAnnotatorResponse)
	err := c.cc.Invoke(ctx, "/ssn.annotator.v1.DocumentAnnotator/Test", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DocumentAnnotatorServer interface {
	...
	Test(context.Context, *DocumentAnnotatorRequest) (*DocumentAnnotatorResponse, error)
}
...
func (UnimplementedDocumentAnnotatorServer) Test(context.Context, *DocumentAnnotatorRequest) (*DocumentAnnotatorResponse, error) {
...
func _DocumentAnnotator_Test_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DocumentAnnotatorRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DocumentAnnotatorServer).Test(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ssn.annotator.v1.DocumentAnnotator/Test",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DocumentAnnotatorServer).Test(ctx, req.(*DocumentAnnotatorRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DocumentAnnotator_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Test",
			Handler:    _DocumentAnnotator_Test_Handler,
		},
	},
