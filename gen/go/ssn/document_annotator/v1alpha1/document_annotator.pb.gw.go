...
/*
Package document_annotator is a reverse proxy.
...
var (
	pattern_DocumentAnnotator_AnnotateDocument_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1alpha1", "document"}, "annotate"))
)
