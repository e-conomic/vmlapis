...
var file_ssn_type_tier_proto_rawDesc = string([]byte{
	...
	0x95, 0x01, 0x0a, 0x11, 0x61, 0x69, 0x2e, 0x76, 0x69, 0x73, 0x6d, 0x61, 0x2e, 0x73, 0x73, 0x6e,
	0x2e, 0x74, 0x79, 0x70, 0x65, 0x42, 0x09, 0x54, 0x69, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var (
	...
	file_ssn_type_tier_proto_rawDescData []byte
)

func file_ssn_type_tier_proto_rawDescGZIP() []byte {
	file_ssn_type_tier_proto_rawDescOnce.Do(func() {
		file_ssn_type_tier_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ssn_type_tier_proto_rawDesc), len(file_ssn_type_tier_proto_rawDesc)))
	})
	return file_ssn_type_tier_proto_rawDescData
}

var file_ssn_type_tier_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_ssn_type_tier_proto_goTypes = []any{
...
func file_ssn_type_tier_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ssn_type_tier_proto_rawDesc), len(file_ssn_type_tier_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
