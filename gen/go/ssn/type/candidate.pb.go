...
var file_ssn_type_candidate_proto_rawDesc = []byte{
	...
	0x65, 0x4a, 0x04, 0x08, 0x0f, 0x10, 0x10, 0x4a, 0x04, 0x08, 0x10, 0x10, 0x11, 0x22, 0xb7, 0x01,
...
var file_ssn_type_candidate_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_ssn_type_candidate_proto_goTypes = []interface{}{
	...
	(*BoundingPoly)(nil),          // 9: ssn.type.BoundingPoly
...
var file_ssn_type_candidate_proto_depIdxs = []int32{
	...
	8,  // 1: ssn.type.Confidence.value:type_name -> google.protobuf.FloatValue
	2,  // 2: ssn.type.Candidate.confidence:type_name -> ssn.type.Confidence
	9,  // 3: ssn.type.Candidate.bounding_box:type_name -> ssn.type.BoundingPoly
	...
	10, // 6: ssn.type.ModelSpec.model_ver:type_name -> google.protobuf.Int64Value
