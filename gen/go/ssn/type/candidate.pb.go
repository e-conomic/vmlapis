...
type VatLevelCandidate struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The vat level in percentage
	VatLevelPercentage string `protobuf:"bytes,1,opt,name=vat_level_percentage,json=vatLevelPercentage,proto3" json:"vat_level_percentage,omitempty"`
	// The vat level in amount
	VatLevelAmount string `protobuf:"bytes,2,opt,name=vat_level_amount,json=vatLevelAmount,proto3" json:"vat_level_amount,omitempty"`
	// Model metadata
	ModelMetadata *ModelSpec `protobuf:"bytes,3,opt,name=model_metadata,json=modelMetadata,proto3" json:"model_metadata,omitempty"`
}

func (x *VatLevelCandidate) Reset() {
	*x = VatLevelCandidate{}
	if protoimpl.UnsafeEnabled {
...
func (x *VatLevelCandidate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VatLevelCandidate) ProtoMessage() {}

func (x *VatLevelCandidate) ProtoReflect() protoreflect.Message {
	mi := &file_ssn_type_candidate_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VatLevelCandidate.ProtoReflect.Descriptor instead.
func (*VatLevelCandidate) Descriptor() ([]byte, []int) {
	return file_ssn_type_candidate_proto_rawDescGZIP(), []int{7}
}

func (x *VatLevelCandidate) GetVatLevelPercentage() string {
	if x != nil {
		return x.VatLevelPercentage
	}
	return ""
}

func (x *VatLevelCandidate) GetVatLevelAmount() string {
	if x != nil {
		return x.VatLevelAmount
	}
	return ""
}

func (x *VatLevelCandidate) GetModelMetadata() *ModelSpec {
	if x != nil {
		return x.ModelMetadata
	}
	return nil
...
var file_ssn_type_candidate_proto_rawDesc = []byte{
	...
	,
...
var file_ssn_type_candidate_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_ssn_type_candidate_proto_goTypes = []interface{}{
	...
	(*VatLevelCandidate)(nil),     // 9: ssn.type.VatLevelCandidate
...
var file_ssn_type_candidate_proto_depIdxs = []int32{
	...
	10, // 1: ssn.type.Confidence.value:type_name -> google.protobuf.FloatValue
	2,  // 2: ssn.type.Candidate.confidence:type_name -> ssn.type.Confidence
	11, // 3: ssn.type.Candidate.bounding_box:type_name -> ssn.type.BoundingPoly
	...
	12, // 6: ssn.type.ModelSpec.model_ver:type_name -> google.protobuf.Int64Value
	...
	4,  // 10: ssn.type.VatLevelCandidate.model_metadata:type_name -> ssn.type.ModelSpec
...
func file_ssn_type_candidate_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ssn_type_candidate_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VatLevelCandidate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
