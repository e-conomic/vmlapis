...
var file_ssn_type_candidate_proto_rawDesc = string([]byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x69, 0x6e, 0x63, 0x6c, 0x56, 0x61, 0x74, 0x22, 0x31, 0x0a, 0x10, 0x44,
	0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12,
	0x1d, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x09, 0x70, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x9a,
...
var (
	...
	file_ssn_type_candidate_proto_rawDescData []byte
)

func file_ssn_type_candidate_proto_rawDescGZIP() []byte {
	file_ssn_type_candidate_proto_rawDescOnce.Do(func() {
		file_ssn_type_candidate_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ssn_type_candidate_proto_rawDesc), len(file_ssn_type_candidate_proto_rawDesc)))
	})
...
var file_ssn_type_candidate_proto_goTypes = []any{
...
func file_ssn_type_candidate_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ssn_type_candidate_proto_rawDesc), len(file_ssn_type_candidate_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
