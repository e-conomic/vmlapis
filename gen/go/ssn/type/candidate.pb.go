...
type PurchaseLineCandidate struct {
	...
	LineTotal string `protobuf:"bytes,15,opt,name=line_total,json=lineTotal,proto3" json:"line_total,omitempty"`
	// Line unit price is the unit price of the line (with/without vat)
	LineUnitPrice string `protobuf:"bytes,16,opt,name=line_unit_price,json=lineUnitPrice,proto3" json:"line_unit_price,omitempty"`
}
...
func (x *PurchaseLineCandidate) GetLineTotal() string {
	if x != nil {
		return x.LineTotal
	}
	return ""
...
func (x *PurchaseLineCandidate) GetLineUnitPrice() string {
	if x != nil {
		return x.LineUnitPrice
	}
	return ""
}
...
var file_ssn_type_candidate_proto_rawDesc = []byte{
	...
	0x0d, 0x52, 0x07, 0x70, 0x61, 0x67, 0x65, 0x52, 0x65, 0x66, 0x22, 0xc6, 0x04, 0x0a, 0x15, 0x50,
	...
	0x50, 0x72, 0x69, 0x63, 0x65, 0x45, 0x78, 0x63, 0x6c, 0x56, 0x61, 0x74, 0x12, 0x1d, 0x0a, 0x0a,
	0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x09, 0x6c, 0x69, 0x6e, 0x65, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x26, 0x0a, 0x0f, 0x6c,
	0x69, 0x6e, 0x65, 0x5f, 0x75, 0x6e, 0x69, 0x74, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x10,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x6c, 0x69, 0x6e, 0x65, 0x55, 0x6e, 0x69, 0x74, 0x50, 0x72,
	0x69, 0x63, 0x65, 0x42, 0x9a, 0x01, 0x0a, 0x11, 0x61, 0x69, 0x2e, 0x76, 0x69, 0x73, 0x6d, 0x61,
