...
const (
	MlService_FeatureGen_FullMethodName        = "/ssn.mlservice.v2.MlService/FeatureGen"
	MlService_Predict_FullMethodName           = "/ssn.mlservice.v2.MlService/Predict"
	MlService_FeatureGenPredict_FullMethodName = "/ssn.mlservice.v2.MlService/FeatureGenPredict"
)
...
func (c *mlServiceClient) FeatureGen(ctx context.Context, in *FeatureGenRequest, opts ...grpc.CallOption) (*FeatureGenResponse, error) {
	...
	err := c.cc.Invoke(ctx, MlService_FeatureGen_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mlServiceClient) Predict(ctx context.Context, in *PredictRequest, opts ...grpc.CallOption) (*PredictResponse, error) {
	...
	err := c.cc.Invoke(ctx, MlService_Predict_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mlServiceClient) FeatureGenPredict(ctx context.Context, in *FeatureGenPredictRequest, opts ...grpc.CallOption) (*PredictResponse, error) {
	out := new(PredictResponse)
	err := c.cc.Invoke(ctx, MlService_FeatureGenPredict_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MlService_FeatureGen_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MlService_FeatureGen_FullMethodName,
	}
...
func _MlService_FeatureGenPredict_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MlService_FeatureGenPredict_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func NewPurchaseLinesClient(cc grpc.ClientConnInterface) PurchaseLinesClient {
...
// Use of this interface is not recommended, as added methods to PurchaseLinesServer will
// result in compilation errors.
type UnsafePurchaseLinesServer interface {
	mustEmbedUnimplementedPurchaseLinesServer()
}

func RegisterPurchaseLinesServer(s grpc.ServiceRegistrar, srv PurchaseLinesServer) {
...
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var PurchaseLines_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ssn.mlservice.v2.PurchaseLines",
