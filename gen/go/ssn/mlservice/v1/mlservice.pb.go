...
func (*PredictedField) Descriptor() ([]byte, []int) {
	return fileDescriptor_mlservice_943ee02fd837a505, []int{0}
}
...
func (*MlRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_mlservice_943ee02fd837a505, []int{1}
}
...
func (*MlResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_mlservice_943ee02fd837a505, []int{2}
}
...
func _MlResponse_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *MlResponse_OcrIneDk:
		...
		if err := b.EncodeMessage(x.OcrIneDk); err != nil {
			return err
		}
...
func _MlResponse_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*MlResponse)
	switch tag {
	case 12: // ocrLine.ocr_ine_dk
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(MlResponse_OcrLineDk)
		err := b.DecodeMessage(msg)
		m.OcrLine = &MlResponse_OcrIneDk{msg}
		return true, err
...
func (*MlResponse_OcrLineDk) Descriptor() ([]byte, []int) {
	return fileDescriptor_mlservice_943ee02fd837a505, []int{2, 0}
}
...
func (*MlResponse_OcrLineSe) Descriptor() ([]byte, []int) {
	return fileDescriptor_mlservice_943ee02fd837a505, []int{2, 1}
}
...
func (*MlResponse_OcrLineNo) Descriptor() ([]byte, []int) {
	return fileDescriptor_mlservice_943ee02fd837a505, []int{2, 2}
}
...
func (*MlResponse_OcrLineNl) Descriptor() ([]byte, []int) {
	return fileDescriptor_mlservice_943ee02fd837a505, []int{2, 3}
}
...
func (*MlResponse_OcrLineFi) Descriptor() ([]byte, []int) {
	return fileDescriptor_mlservice_943ee02fd837a505, []int{2, 4}
}
...
func init() {
	proto.RegisterFile("ssn/mlservice/v1/mlservice.proto", fileDescriptor_mlservice_943ee02fd837a505)
}

var fileDescriptor_mlservice_943ee02fd837a505 = []byte{
