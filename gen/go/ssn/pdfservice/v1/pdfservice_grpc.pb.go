...
const (
	PdfService_InternalRasterizePdf_FullMethodName = "/ssn.pdfservice.v1.PdfService/InternalRasterizePdf"
	PdfService_RasterizePdf_FullMethodName         = "/ssn.pdfservice.v1.PdfService/RasterizePdf"
)
...
func (c *pdfServiceClient) InternalRasterizePdf(ctx context.Context, in *RasterizePdfRequest, opts ...grpc.CallOption) (PdfService_InternalRasterizePdfClient, error) {
	stream, err := c.cc.NewStream(ctx, &PdfService_ServiceDesc.Streams[0], PdfService_InternalRasterizePdf_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *pdfServiceClient) RasterizePdf(ctx context.Context, in *RasterizePdfRequest, opts ...grpc.CallOption) (PdfService_RasterizePdfClient, error) {
	stream, err := c.cc.NewStream(ctx, &PdfService_ServiceDesc.Streams[1], PdfService_RasterizePdf_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
