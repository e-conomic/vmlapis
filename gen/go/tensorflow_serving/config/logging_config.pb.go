...
func (*SamplingConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_logging_config_d1b82a9df427a492, []int{0}
}
...
func (*LoggingConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_logging_config_d1b82a9df427a492, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/config/logging_config.proto", fileDescriptor_logging_config_d1b82a9df427a492)
}

var fileDescriptor_logging_config_d1b82a9df427a492 = []byte{
