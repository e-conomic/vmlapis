...
func (*LogCollectorConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_collector_config_eab60e7bc6cc9f8f, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/config/log_collector_config.proto", fileDescriptor_log_collector_config_eab60e7bc6cc9f8f)
}

var fileDescriptor_log_collector_config_eab60e7bc6cc9f8f = []byte{
