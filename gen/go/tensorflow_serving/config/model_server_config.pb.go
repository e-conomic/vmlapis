...
import fmt "fmt"
import math "math"
import storage_path "github.com/e-conomic/vmlapis/gen/go/tensorflow_serving/sources/storage_path"
...
func (ModelType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_model_server_config_2fa88b02c0627e92, []int{0}
}
...
func (*ModelConfigList) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_server_config_2fa88b02c0627e92, []int{1}
}
...
type ModelServerConfig struct {
	// ModelServer takes either a static file-based tfserving config list or an Any
	// proto representing custom tfserving config that is fetched dynamically at
...
func (*ModelServerConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_server_config_2fa88b02c0627e92, []int{2}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/config/model_server_config.proto", fileDescriptor_model_server_config_2fa88b02c0627e92)
}

var fileDescriptor_model_server_config_2fa88b02c0627e92 = []byte{
