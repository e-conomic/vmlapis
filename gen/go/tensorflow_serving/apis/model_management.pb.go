...
import fmt "fmt"
import math "math"
import config "github.com/e-conomic/vmlapis/gen/go/tensorflow_serving/config"
...
func (*ReloadConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_management_d4f7d6ab455868b0, []int{0}
}
...
func (*ReloadConfigResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_management_d4f7d6ab455868b0, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/model_management.proto", fileDescriptor_model_management_d4f7d6ab455868b0)
}

var fileDescriptor_model_management_d4f7d6ab455868b0 = []byte{
