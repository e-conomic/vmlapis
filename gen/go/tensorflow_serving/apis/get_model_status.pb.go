...
import fmt "fmt"
import math "math"
import util "github.com/e-conomic/vmlapis/gen/go/tensorflow_serving/util"
...
func (ModelVersionStatus_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_get_model_status_9db23183153c86be, []int{1, 0}
}
...
func (*GetModelStatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_status_9db23183153c86be, []int{0}
}
...
func (*ModelVersionStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_status_9db23183153c86be, []int{1}
}
...
func (*GetModelStatusResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_status_9db23183153c86be, []int{2}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/get_model_status.proto", fileDescriptor_get_model_status_9db23183153c86be)
}

var fileDescriptor_get_model_status_9db23183153c86be = []byte{
