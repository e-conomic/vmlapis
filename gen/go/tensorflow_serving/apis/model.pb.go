...
type ModelSpec struct {
	...
	// Optional choice of which version of the tfserving to use.
	//
...
func (*ModelSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_2b739a1612d96553, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/model.proto", fileDescriptor_model_2b739a1612d96553)
}

var fileDescriptor_model_2b739a1612d96553 = []byte{
