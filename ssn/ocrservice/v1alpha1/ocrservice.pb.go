...
func (*OcrScanImageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_474c60fbc3a12ac4, []int{0}
}
...
func (*OcrScanImageResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_474c60fbc3a12ac4, []int{1}
}
...
func init() {
	proto.RegisterFile("ssn/ocrservice/v1alpha1/ocrservice.proto", fileDescriptor_474c60fbc3a12ac4)
}

var fileDescriptor_474c60fbc3a12ac4 = []byte{
