build-py:
	...
	python3 -m grpc_tools.protoc -I . --python_out=. --grpc_python_out=. ssn/usermgntservice/v1alpha1/usermgntservice.proto
	...
	touch ./ssn/usermgntservice/__init__.py
	touch ./ssn/usermgntservice/v1alpha1/__init__.py
...
build-go:
	...
	protoc -I . ssn/usermgntservice/v1alpha1/*.proto  --go_out=plugins=grpc,paths=source_relative:.
