build-py:
	...
	python3 -m grpc_tools.protoc -I . --python_out=. --grpc_python_out=. ssn/usermgnt/v1alpha1/usermgnt.proto
	...
	touch ./ssn/usermgnt/__init__.py
	touch ./ssn/usermgnt/v1alpha1/__init__.py
